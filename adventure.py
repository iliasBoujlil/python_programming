...
if character == "Programmer":
    ...
    print ("You're in a dimly lit room, standing in front of an enourmous steel chest")
    option = input("Do you want to open the chest or leave the room? \n>")
    if option == "Open" or option == "OPEN" or option == "open":
        import random
        num = random.randint(1,20)
        if num >= 1 and num <= 5:
            print ("Its filled with spiders! RUN!")
        elif num >= 6 and num <=10:
            print ("Nothing happens...well this is awkward...")
        elif num >= 11 and num <= 15:
            print ("You found a sack of gold! What a surprise!")
        elif num > 15 and num <= 20:
            print ("Its filled with diamonds! So shiny...")
    elif option == "Leave" or option == "LEAVE" or option == "leave":
            print ("Nothing happens. Very boring game eh?")
    else:
            print ("A sorcerer emerges from the shadows and casts an aging spell on you! Should've just opened or left")
else:
