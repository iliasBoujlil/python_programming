...
"""
name = str(input("Hi there. I'm Grade Bot 3K. What is your name?\n>"))
classes = input("Hi " + name +" What class are you in?\n>")
tests = float(input("What percent are tests worth in your class? (decimal less than 1)\n>"))
test_score1 = float(input("What was your score for test 1?\n>"))
test_score2 = float(input("What was your score for test 2?\n>"))
test_avg = (test_score1+test_score2)/2
print ("Your test average is:",format(test_avg,'.2f') + "%")
homework = float(input("What percent are homeworks worth in your class? (decimal less than 1)\n>"))
homework1 = float(input("what was your score for hw 1?\n>"))
homework2 = float(input("What was your score for hw 2?\n>"))
homework_avg = (homework1+homework2)/2
print ("Your homework average is:",format(homework_avg,'.2f') + "%")
final_grade = (test_avg * tests) + (homework_avg * homework)
print ("Your final grade for the",classes,"class is:",format(final_grade,'.2f') +"%")
